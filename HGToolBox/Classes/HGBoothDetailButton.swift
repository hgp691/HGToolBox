...
public class HGBoothDetailButton: UIView {
    ...
    private var _viewIzquierda:UIImageView!
    ...
    private func configurarBoton(){
        ...
        if self._viewIzquierda == nil{
            self._viewIzquierda = UIImageView()
            self._contenedor2.addSubview(self._viewIzquierda)
        ...
        if self._placeHolder == nil{
            ...
            self._placeHolder.textAlignment = .left
